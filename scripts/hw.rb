...
#  :compiler_options => ['-mcpu=cortex-m4 -mthumb -g2 -Wall -O0 -g'],          # Other compiler options
  :compiler_options => ['-mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -g2 -Wall -O0 -g -Wno-unused-variable -Wno-unused-but-set-variable'],          # Other compiler options
